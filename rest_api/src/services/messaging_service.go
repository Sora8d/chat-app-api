...
type MessagingServiceInterface interface {
	...
	GetMessagesByConversation(context.Context, *messaging.MessageRequest) domain.Response
...
func (ms messagingService) GetMessagesByConversation(ctx context.Context, request *messaging.MessageRequest) domain.Response {
